 ...
 * PA8 UART1 Tx to other microcontroller PA22 Rx<br>
 ...
 * Uses no synchronization, blind<br>
 * This function does not wait, if the transmitter hardware FIFO is full, data will be lost
