...
void Key_Init(void){
    ...
    IOMUX->SECCFG.PINCM[PB16INDEX]          //these are the switches so just need to set the inputs
    ...
    IOMUX->SECCFG.PINCM[PB18INDEX]
         =0X00040081; //INPUT PB18

    IOMUX->SECCFG.PINCM[PB19INDEX]
         =0X00040081; //INPUT PB19
...
uint32_t Key_In(void){
    return (GPIOB->DIN31_0>>16 & 0x0000000F);
  //return 0;
}
